...
const funMessages = [
  { emoji: '⭐', text: "Psst... stars fuel my caffeine addiction", subtext: "Help a dev out?" },
  { emoji: '🌟', text: "This CV is looking stellar!", subtext: "Know what else could be stellar? Our GitHub stars" },
  { emoji: '✨', text: "Free & open source", subtext: "A star would make our day (and cost you nothing)" },
  { emoji: '🚀', text: "You're building an amazing CV!", subtext: "Maybe drop us a star on your way out?" },
  { emoji: '💜', text: "Made with love", subtext: "Stars = love. It's simple math, really" },
  { emoji: '🎯', text: "Hit that star button", subtext: "It's like a high-five, but for code" },
  { emoji: '☕', text: "Stars > Coffee", subtext: "Okay that's a lie, but stars are still nice" },
  { emoji: '🔥', text: "Your CV is fire!", subtext: "Our repo could use some heat too ⭐" },
];

export default function GitHubStarFloat({ theme = 'dark' }: GitHubStarFloatProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Glow effect */}
        <div className={`absolute inset-0 rounded-2xl opacity-50 blur-xl -z-10 ${isDark ? 'bg-gradient-to-r from-yellow-500/20 to-orange-500/20' : 'bg-gradient-to-r from-yellow-400/30 to-orange-400/30'}`} />
